...
class Membership(Base):
    ...
    surcharge_amount: Mapped[float] = mapped_column(Float, default=0)
    pricing_note: Mapped[str | None] = mapped_column(String(255))
...
class PtSessionLog(Base):
    ...
    training_date: Mapped[date | None] = mapped_column(Date, index=True)
