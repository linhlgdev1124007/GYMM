...
def membership_data(membership, include_payments=False, include_history=False):
    data = {
        ...
        "basePrice": membership.base_price or 0,
        "discountType": membership.discount_type or "none",
        "discountValue": membership.discount_value or 0,
        "discountAmount": membership.discount_amount or 0,
        "surchargeAmount": membership.surcharge_amount or 0,
        "pricingNote": membership.pricing_note,
